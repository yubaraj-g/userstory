...
function Mainbody() {
    return (
        <div className='px-40 flex flex-col items-center h-fit pb-20'>
            ...
            <form action="" className='px-32 w-full flex flex-col gap-4 pb-8'>
                <textarea className='border border-gray-300 w-full h-40 rounded-md outline-1 outline-slate-400 px-4 py-3'></textarea>
                <button className='bg-indigo-700 mx-auto text-white font-bold text-md py-2 w-full rounded-md hover:bg-indigo-900'>Create User Story</button>
            </form>
